...
urlpatterns = [
    ...
    path(
        "courses/<slug:slug>/restore-from-rejected/",
        CourseRestoreFromRejectedView.as_view(),
        name="course-restore-from-rejected",
    ),
    path(
        "courses/<slug:slug>/copy-to-draft/",
        CourseCopyToDraftView.as_view(),
        name="course-copy-to-draft",
    ),
    ...
    path(
        "courses/<slug:slug>/certificate-preview/",
        CourseCertificatePreviewView.as_view(),
        name="course-certificate-preview",
    ),
    path(
        "courses/moderation/unassigned/",
        UnassignedModerationCoursesView.as_view(),
        name="moderation-unassigned",
    ),
    path("courses/moderation/my/", MyModerationCoursesView.as_view(), name="moderation-my"),
    path(
        "courses/moderation/rejected/",
        MyRejectedModerationCoursesView.as_view(),
        name="moderation-rejected",
    ),
    path(
        "courses/moderation/rejection-records/",
        ModeratorRejectionRecordsView.as_view(),
        name="moderation-rejection-records",
    ),
    path(
        "courses/moderation/approval-records/",
        ModeratorApprovalRecordsView.as_view(),
        name="moderation-approval-records",
    ),
    path(
        "courses/my-rejection-records/",
        TeacherRejectionRecordsView.as_view(),
        name="teacher-rejection-records",
    ),
    path(
        "courses/<slug:slug>/assign-moderator/",
        CourseAssignModeratorView.as_view(),
        name="course-assign-moderator",
    ),
    ...
    path(
        "courses/<slug:slug>/save-review-draft/",
        SaveReviewDraftView.as_view(),
        name="save-review-draft",
    ),
    path("courses/<slug:slug>/pending-edit/", CoursePendingEditView.as_view(), name="pending-edit"),
    path(
        "courses/<slug:slug>/pending-edit/submit/",
        CoursePendingEditSubmitView.as_view(),
        name="pending-edit-submit",
    ),
    path(
        "courses/<slug:slug>/pending-edit/withdraw/",
        CoursePendingEditWithdrawView.as_view(),
        name="pending-edit-withdraw",
    ),
    path(
        "courses/<slug:slug>/pending-edit/approve/",
        CoursePendingEditApproveView.as_view(),
        name="pending-edit-approve",
    ),
    path(
        "courses/<slug:slug>/pending-edit/reject/",
        CoursePendingEditRejectView.as_view(),
        name="pending-edit-reject",
    ),
    path(
